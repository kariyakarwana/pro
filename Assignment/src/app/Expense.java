...
public class Expense extends JFrame {
    ...
    private void initComponents() {
        ...
        btnAddExpense.setBounds(10, 130, 270, 25);
        btnAddExpense.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (addExpenseToDatabase(date, description, amount)) {
    ...
    private boolean addExpenseToDatabase(String date, String description, double amount) {
